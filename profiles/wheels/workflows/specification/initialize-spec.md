...
# This ensures multiple specs created the same day are properly sequenced
DATETIME=$(date +%Y-%m-%d-%H%M)

# Determine kebab-case spec name from user's description
SPEC_NAME="[kebab-case-name]"

# Create dated folder name with time prefix
DATED_SPEC_NAME="${DATETIME}-${SPEC_NAME}"
...
- Always use datetime folder names (YYYY-MM-DD-HHMM-spec-name) to ensure proper sequencing
